...
//react-router-dom React 앱에서 라우팅 구현위해 사용하는 라이브러리(설치필요)
//라우팅(Routing) 사용자가 요청한 URL 경로에 따라 적절한 페이지나 자원 제공하는 과정
export default function DashBoard() {
  ...
  const goDashBoardMain=()=>{
    ...
    //  location.href = "/";
    //  React 사용은 가능하나 권장 x
    //  브라우저의 기본동작을 이용해 '새로고침하며 이동'하는 방식
