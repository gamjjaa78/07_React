...
//Context는 Provider제공자와 Consumer소비자 존재
...
//localStorage :
//-브라우저닫아도 데이터가 영구유지, 브라우저 전역에서 사용(모든탭과 창에서 공유)
//-유효기간 만료기능없음

//sessionStorage :
//-브라우저 탭 또는 창 닫으면 데이터가 즉시 삭제
//-현재 탭 또는 창에서만 데이터 유지
//-유효기간 만료기능 없음